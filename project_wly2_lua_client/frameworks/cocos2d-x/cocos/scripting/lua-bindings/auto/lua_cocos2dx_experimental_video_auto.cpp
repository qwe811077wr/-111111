...
int lua_cocos2dx_experimental_video_VideoPlayer_addSkipButton(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::VideoPlayer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_video_VideoPlayer_addSkipButton'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_video_VideoPlayer_addSkipButton'", nullptr);
            return 0;
        }
        cobj->addSkipButton();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.VideoPlayer:addSkipButton",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_video_VideoPlayer_addSkipButton'.",&tolua_err);
#endif

    return 0;
}

int lua_cocos2dx_experimental_video_VideoPlayer_setSkipButtonAttr(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::VideoPlayer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_video_VideoPlayer_setSkipButtonAttr'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccexp.VideoPlayer:setSkipButtonAttr");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_video_VideoPlayer_setSkipButtonAttr'", nullptr);
            return 0;
        }
        cobj->setSkipButtonAttr(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.VideoPlayer:setSkipButtonAttr",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_video_VideoPlayer_setSkipButtonAttr'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_experimental_video_VideoPlayer(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"VideoPlayer");
        ...
        tolua_function(tolua_S,"addSkipButton", lua_cocos2dx_experimental_video_VideoPlayer_addSkipButton);
        tolua_function(tolua_S,"setSkipButtonAttr", lua_cocos2dx_experimental_video_VideoPlayer_setSkipButtonAttr);
