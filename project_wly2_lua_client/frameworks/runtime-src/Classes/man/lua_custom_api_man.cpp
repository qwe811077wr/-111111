#include "lua_custom_api_man.hpp"
...
int lua_custom_Utils_getPixelColor(lua_State* tolua_S)
{
    ...
    if (argc == 3)
    {
        ...
        ok &= luaval_to_ulong(tolua_S, 3, &arg1, "uq.Utils:getPixelColor");
        ok &= luaval_to_ulong(tolua_S, 4, &arg2, "uq.Utils:getPixelColor");
        if(!ok)
        {
...
int lua_custom_RichText_insertElement(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_insertElement'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_insertElement'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_insertElement'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_pushBackElement(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_pushBackElement'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_pushBackElement'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_pushBackElement'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_setVerticalSpace(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_setVerticalSpace'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_setVerticalSpace'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_setVerticalSpace'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_getTextRealSize(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_getTextRealSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_getTextRealSize'", nullptr);
            return 0;
        }
        cocos2d::Size ret = cobj->getTextRealSize();
        size_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichText:getTextRealSize",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_getTextRealSize'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_formatText(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_formatText'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_formatText'", nullptr);
            return 0;
        }
        cobj->formatText();
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_formatText'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_setGetLineNumberListener(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_setGetLineNumberListener'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_setGetLineNumberListener'", nullptr);
            return 0;
        }
        cobj->setGetLineNumberListener(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichText:setGetLineNumberListener",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_setGetLineNumberListener'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_removeElement(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_custom_RichText_removeElement'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S)-1;
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_removeElement'.",&tolua_err);
#endif

    return 0;
}
int lua_custom_RichText_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_create'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_create'.",&tolua_err);
#endif
    return 0;
}
int lua_custom_RichText_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_custom_RichText_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_custom_RichText_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_custom_RichText_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichText)");
    return 0;
}

int lua_register_custom_RichText(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"RichText");
        tolua_function(tolua_S,"new",lua_custom_RichText_constructor);
        tolua_function(tolua_S,"insertElement",lua_custom_RichText_insertElement);
        tolua_function(tolua_S,"pushBackElement",lua_custom_RichText_pushBackElement);
        tolua_function(tolua_S,"setVerticalSpace",lua_custom_RichText_setVerticalSpace);
        tolua_function(tolua_S,"getTextRealSize",lua_custom_RichText_getTextRealSize);
        tolua_function(tolua_S,"formatText",lua_custom_RichText_formatText);
        tolua_function(tolua_S,"setGetLineNumberListener",lua_custom_RichText_setGetLineNumberListener);
        tolua_function(tolua_S,"removeElement",lua_custom_RichText_removeElement);
        tolua_function(tolua_S,"create", lua_custom_RichText_create);
    tolua_endmodule(tolua_S);
...
TOLUA_API int register_all_custom(lua_State* tolua_S)
{
	...
	lua_register_custom_RichText(tolua_S);
