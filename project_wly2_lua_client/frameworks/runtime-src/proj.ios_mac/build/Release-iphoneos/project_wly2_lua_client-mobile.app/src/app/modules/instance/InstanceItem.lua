...
InstanceItem.RESOURCE_BINDING = {
    ...
    ["panel_touch"]  = {["varname"] = "_panelTouch",["events"] = {{["event"] = "touch",["method"] = "onHead"}}},
    ["image_head"]   = {["varname"] = "_imageHead",["events"] = {{["event"] = "touch",["method"] = "onHead"}}},
    ["image_bg"]     = {["varname"] = "_imgBg",["events"] = {{["event"] = "touch",["method"] = "onHead"}}},
