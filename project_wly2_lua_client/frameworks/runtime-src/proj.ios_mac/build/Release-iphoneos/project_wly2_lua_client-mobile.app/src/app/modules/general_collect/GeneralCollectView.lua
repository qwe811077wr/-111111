...
GeneralCollectView.RESOURCE_BINDING = {
    ...
    ["tab_1"]            ={["varname"]="_tab1",["events"]={{["event"]="touch",["method"]="onTabChange"}}},
    ["tab_2"]            ={["varname"]="_tab3",["events"]={{["event"]="touch",["method"]="onTabChange"}}},
    ["tab_3"]            ={["varname"]="_tab4",["events"]={{["event"]="touch",["method"]="onTabChange"}}},
    ["tab_4"]            ={["varname"]="_tab2",["events"]={{["event"]="touch",["method"]="onTabChange"}}},
    ["tab_4_0"]          ={["varname"]="_tab5",["events"]={{["event"]="touch",["method"]="onTabChange"}}},
    ["tab_5"]            ={["varname"]="_tab6",["events"]={{["event"]="touch",["method"]="onTabChange"}}},
    ["btn_illustration"] ={["varname"]="_btnIllustration",["events"]={{["event"]="touch",["method"]="onIllustration"}}},
...
function GeneralCollectView:tableCellTouchedTop(view, cell, touch)
    ...
    for i = 0, 4, 1 do
        ...
        if cc.rectContainsPoint(rect, pos) then
            ...
            uq.runCmd('open_general_attribute', {{generals_id = tab_list.id, index = idx, occupation = self._curType, max_index = max_num}})
            break
        end
        index = index + 1
    end
