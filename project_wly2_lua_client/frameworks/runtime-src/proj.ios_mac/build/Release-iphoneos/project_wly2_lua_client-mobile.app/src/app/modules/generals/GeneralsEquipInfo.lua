...
GeneralsEquipInfo.RESOURCE_BINDING  = {
    ["panel_strength/btn_replace"]                     ={["varname"] = "_btnReplace",["events"] = {{["event"] = "touch",["method"] = "onBtnReplace"}}},
    ["panel_strength/btn_unload"]                      ={["varname"] = "_btnUnload",["events"] = {{["event"] = "touch",["method"] = "onUnload"}}},
    ...
    ["Button_8"]                                       ={["varname"] = "_btnshowSuitInfo",["events"] = {{["event"] = "touch", ["method"] = "_onShowSuitInfo"}}},
    ...
    ["panel_strength/btn_strength0"]                   ={["varname"] = "_btnStrengthMore",["events"] = {{["event"] = "touch",["method"] = "onBtnStrengthMore"}}},
    ["panel_strength/btn_strength1"]                   ={["varname"] = "_btnStrengthOne",["events"] = {{["event"] = "touch",["method"] = "onBtnStrengthOne"}}},
...
function GeneralsEquipInfo:initPanelItems()
    ...
    for i = 1, 7 do
        ...
        item:setPositionY(pos_y - 95 * (i - 1))
        item:setTag(i)
...
function GeneralsEquipInfo:tableCellAtIndex(view, idx)
    ...
    if not cell then
        ...
        for i = 0, 4, 1 do
            ...
            item:setName("item" .. i)
            item:setScale(scale)
            item:setPosition(cc.p((size.width * scale + 5) * (i + 0.5) + 15, size.height / 2 * scale))
            img:setPosition(cc.p((size.width * scale + 5) * (i + 0.5) + 15, size.height / 2 * scale))
            img:setVisible(true)
            cell:addChild(img)
            cell:addChild(item)
        ...
        for i = 0, 4, 1 do
            ...
            if not item then
                ...
                item:setName("item" .. i)
                item:setScale(0.8)
                item:setPosition(cc.p((size.width * 0.8 + 5) * (i - 0.5) + 15, size.height / 2 * 0.8 + 10))
                table.insert(self._cellArray, item)
                cell:addChild(item)
            end
            local info = self._allMaterials[index]
