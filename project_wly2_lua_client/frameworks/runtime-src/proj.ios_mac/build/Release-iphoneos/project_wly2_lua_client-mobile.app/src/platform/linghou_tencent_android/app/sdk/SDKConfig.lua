...
sdk.platform 	= "linghou_tencent"
sdk.ad_id = 170
sdk.platform_id = 1036
sdk.game_id 	= 53
sdk.game_tag 	= "linghouzs"
sdk.pay_url 	= ""
sdk.third_platform = "linghou"
sdk.log_flag 	= 3 --1: 部落大乱斗 2: 萌新出击 3: 王者风暴
sdk.open_pay 	= true
sdk.tencent_debug	= 0 --1: 沙箱 0: 现网
...
sdk.CmdString.TENCENTLOGIN 		= "TencentAutoLogin"
sdk.CmdString.WXLOGINRESP 	 	= "WXLoginResp"
sdk.CmdString.QQLOGINRESP 	 	= "QQLoginResp"
sdk.CmdString.TENCENTLOGINRESP 	= "TencentAutoLoginResp"
