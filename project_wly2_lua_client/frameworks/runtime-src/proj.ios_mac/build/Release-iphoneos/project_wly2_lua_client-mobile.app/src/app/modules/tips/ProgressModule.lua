...
function ProgressModule:init()
    ...
    view:setBackGroundColorOpacity(100)
    ...
    -- loading04.png
    self.img = ccui.ImageView:create("img/new_common/loading04.png")
    ...
    label:setFontName("font/hkchuyuan.ttf")
