...
function LoginModule:init()
	...
	if uq.sdk.platform == "uqee" then
		...
		btnUqee:addClickEventListener(handler(self, self._onShowLoginAccountPop))
		...
		btnWX:addClickEventListener(handler(self, self._onWxLogin))
		...
		btnQQ:addClickEventListener(handler(self, self._onQQLogin))
	...
	btn_account:addClickEventListener(handler(self, self._onSwitchLogin))
	...
	btn_switch_server:addClickEventListener(handler(self, self._onShowServers))
	...
	btn_enter:addClickEventListener(handler(self, self._onEnterGame))
