...
function LoginModule:init()
    ...
    self._btnChoose:addClickEventListenerWithSound(handler(self, self._onChooseTapped))
    self._btnOk:addClickEventListenerWithSound(handler(self, self._onAccountCheck))
    self._btnLogout:addClickEventListenerWithSound(handler(self, self._onBackLogin))
    self._btnAccount:addClickEventListenerWithSound(handler(self, self._showAccountLayer))
    self._btnRegister:addClickEventListenerWithSound(handler(self, self._showRegisterLayer))
