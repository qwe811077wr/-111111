...
GeneralsEquip.RESOURCE_BINDING  = {
    ["btn_change"]        ={["varname"] = "_btnChange",["events"] = {{["event"] = "touch",["method"] = "onBtnChange"}}},
    ["btn_xiexia"]        ={["varname"] = "_btnUnload",["events"] = {{["event"] = "touch",["method"] = "onBtnUnload"}}},
...
function GeneralsEquip:updateEquip()
    for k, v in ipairs(self._equipType) do
        ...
        if info == nil then
            ...
            if max_info ~= nil and max_info.xml.effectValue > max_info.xml.effectValue then
