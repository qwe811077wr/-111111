...
function GeneralsSelect:initDialog()
    ...
    self._imgBg1:addClickEventListenerWithSound(function(sender)
        self._panelTime:setVisible(true)
    end)

    self._imgBg2:setTouchEnabled(true)
    self._imgBg2:addClickEventListenerWithSound(function(sender)
        self._panelType:setVisible(true)
    end)

    self._imgBg3:setTouchEnabled(true)
    self._imgBg3:addClickEventListenerWithSound(function(sender)
