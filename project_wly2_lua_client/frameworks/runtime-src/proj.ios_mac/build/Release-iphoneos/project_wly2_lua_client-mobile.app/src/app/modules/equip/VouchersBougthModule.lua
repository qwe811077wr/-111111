...
VouchersBougthModule.RESOURCE_BINDING = {
    ...
    ["Button_2"]                      = {["varname"] = "_btnBuyTen", ["events"] = {{["event"] = "touch",["method"] = "onBoughtMore"}}},
    ["Button_2_0"]                    = {["varname"] = "_btnBuy", ["events"] = {{["event"] = "touch",["method"] = "onBoughtOnce"}}},
    ...
    ["Button_1"]                      = {["varname"] = "_btnOnExit", ["events"] = {{["event"] = "touch",["method"] = "_onTouchExit"}}}
}
...
function VouchersBougthModule:onBought(tag)
    ...
    network:sendPacket(Protocol.C_2_S_BUY_EQUIPMENT_VOUCHERS, {buy_num = num, is_ten = tag})
end
