...
function MainCityModule:init()
    ...
    uq.AnimationManager:getInstance():dispose('soldier', string.format('%s_%d', soldier.action, 3))
    uq.AnimationManager:getInstance():dispose('soldier', string.format('%s_%d', soldier2.action, 3))
end
