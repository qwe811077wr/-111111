...
function uq.http_request(method, url, params, callback, noCode)
...
function uq.http_login_wx(openid, machineId, callback)
    local uri = "/rest/partner/wechat/mengxin/login"
    local method = "GET"
...
function uq.http_login_qq(openid, openkey, pf, callback)
    local uri = "/rest/partner/qq/mengxin/login"
    local method = "GET"
...
function uq.http_wx_access_token(appid, appsecret, code, callback)
	...
	uq.http_request("GET", url, nil, callback)
end
...
function uq.http_wx_userinfo(accessToken, openid, callback)
	...
	uq.http_request("GET", url, nil, callback, true)
end
