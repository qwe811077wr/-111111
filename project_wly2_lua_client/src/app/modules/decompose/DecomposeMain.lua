...
DecomposeMain.RESOURCE_BINDING = {
    ...
    ["setting_btn"]       ={["varname"]="_btnSetting",["events"] = {{["event"] = "touch",["method"] = "_onSetting",["sound_id"] = 0}}},
    ...
    ["rarity_btn"]        ={["varname"]="_btnRarity",["events"] = {{["event"] = "touch",["method"] = "_onRarity",["sound_id"] = 0}}},
    ["Button_7"]          ={["varname"]="_btnRarity1",["events"] = {{["event"] = "touch",["method"] = "_onChangeSort",["sound_id"] = 66}}},
    ["Button_7_0"]        ={["varname"]="_btnRarity2",["events"] = {{["event"] = "touch",["method"] = "_onChangeSort",["sound_id"] = 66}}},
    ["Button_7_1"]        ={["varname"]="_btnRarity3",["events"] = {{["event"] = "touch",["method"] = "_onChangeSort",["sound_id"] = 66}}},
...
function DecomposeMain:_onDoSell(msg)
    ...
    if data.dbid and next(data.dbid) ~= nil then
