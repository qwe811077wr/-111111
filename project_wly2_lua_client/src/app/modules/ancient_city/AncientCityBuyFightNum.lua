...
AncientCityBugFightNum.RESOURCE_BINDING  = {
    ...
    ["Button_1"]                ={["varname"] = "_btnClose",["events"] = {{["event"] = "touch",["method"] = "_onBtnClose",["sound_id"] = 0}}},
}
...
function AncientCityBugFightNum:initUi()
    ...
    self._addImg:addClickEventListener(function(evt)
    ...
    self._decImg:addClickEventListener(function(evt)
        local cur_num = self._curNum
        if cur_num <= 1 then
            uq.playSoundByID(56)
            return
