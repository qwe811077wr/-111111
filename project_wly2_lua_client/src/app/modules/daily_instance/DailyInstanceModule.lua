...
DailyInstanceModule.RESOURCE_BINDING  = {
    ...
    ["Button_3"]                          = {["varname"] = "_btnBattle",["events"] = {{["event"] = "touch",["method"] = "_onBtnBattle",["sound_id"] = 0}}},
...
function DailyInstanceModule:addTabBtns()
    ...
    for k, v in ipairs(self._curTabInfoArray) do
        ...
        item:addClickEventListener(handler(self, self.onTabChanged))
