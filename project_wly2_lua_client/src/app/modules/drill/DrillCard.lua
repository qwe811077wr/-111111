...
DrillCard.RESOURCE_BINDING = {
    ...
    ["back_btn"]                              = {["varname"] = "_btnBack", ["events"] = {{["event"] = "touch",["method"] = "onBtnBack",["sound_id"] = 0}}},
...
function DrillCard:showFinishLayer()
    ...
    services:dispatchEvent({name = services.EVENT_NAMES.ON_SET_LOCAL_ZORDER, data = zorder - 1})
end
