...
MapGuideInfo.RESOURCE_BINDING  = {
    ...
    ["Panel_1/btn_close"]                               = {["varname"] = "_btnExit", ["events"] = {{["event"] = "touch",["method"] = "_onTouchExit",["sound_id"] = 0}}},
    ["Panel_1/Button_3"]                                = {["varname"] = "_btnDetail", ["events"] = {{["event"] = "touch",["method"] = "_onBtnDetail",["sound_id"] = 0}}},
...
function MapGuideInfo:initDialog()
    ...
    self._panelSelect:addClickEventListenerWithSound(function(sender)
        self._panelSelect:setVisible(false)
    ...
    self._panelReward:addClickEventListenerWithSound(function(sender)
        local illustration_info = uq.cache.illustration:getIllustrationInfoById(self._curTabInfo.ident)
    ...
    self._imgSelect:addClickEventListenerWithSound(function(sender)
