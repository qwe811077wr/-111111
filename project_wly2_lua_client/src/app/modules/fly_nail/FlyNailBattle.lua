...
FlyNailBattle.RESOURCE_BINDING  = {
    ...
    ["Panel_1/Node_soldier/btn_getReward"]          ={["varname"] = "_btnGetReward",["events"] = {{["event"] = "touch",["method"] = "_onBtnGetReward",["sound_id"] = 0}}},
...
function FlyNailBattle:initDialog()
    ...
    self._imgChanges1:addClickEventListener(function(sender)
        self:onChangeTring()
    end)
    self._imgChanges2:setTouchEnabled(true)
    self._imgChanges2:addClickEventListener(function(sender)
        self:onChangeTring()
    end)
