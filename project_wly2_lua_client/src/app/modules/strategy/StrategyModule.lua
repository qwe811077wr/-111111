...
StrategyModule.RESOURCE_BINDING  = {
    ...
    ["Panel_1/Panel_des/btn_study"]                          ={["varname"] = "_btnStudy",["events"] = {{["event"] = "touch",["method"] = "_onBtnStudy",["sound_id"] = 0}}},
    ...
    ["btn_speed"]                                            ={["varname"] = "_btnSpeed",["events"] = {{["event"] = "touch",["method"] = "_onBtnSpeed",["sound_id"] = 0}}},
}
...
function StrategyModule:init()
    ...
    top_ui:addResItem(uq.ui.ResourceBox.createRes(uq.config.constant.COST_RES_TYPE.TECH_POINT, true))
