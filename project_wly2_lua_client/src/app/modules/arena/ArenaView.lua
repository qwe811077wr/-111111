...
ArenaView.RESOURCE_BINDING = {
    ...
    ["Button_reward"] = {["varname"] = "_btnReward",["events"] = {{["event"] = "touch",["method"] = "onReward",["sound_id"] = 0}}},
    ["Button_rank"]   = {["varname"] = "_btnRank",["events"] = {{["event"] = "touch",["method"] = "onRank",["sound_id"] = 0}}},
    ["Button_shop"]   = {["varname"] = "_btnShop",["events"] = {{["event"] = "touch",["method"] = "onShop"}}},
    ["Button_fight"]  = {["varname"] = "_btnFight",["events"] = {{["event"] = "touch",["method"] = "onFight",["sound_id"] = 0}}},
    ["Button_report"] = {["varname"] = "_btnReport",["events"] = {{["event"] = "touch",["method"] = "onReport",["sound_id"] = 0}}},
    ...
    ["Button_1_1_1"]  = {["varname"] = "_btnBuyTime",["events"] = {{["event"] = "touch",["method"] = "onBuyChallengeTime",["sound_id"] = 0}}},
...
function ArenaView:refreshPower()
    self._curPower:setString(uq.cache.role.athleticPower)
end
...
function ArenaView:refreshChallenge(challengers)
    ...
    local data = {
        power    = uq.cache.role.athleticPower,
        rank     = self._rank,
        img_type = uq.cache.role.img_type,
        img_id   = uq.cache.role.img_id,
