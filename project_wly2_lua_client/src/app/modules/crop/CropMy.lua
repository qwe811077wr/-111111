...
CropMy.RESOURCE_BINDING = {
    ...
    ["Button_1_1"]                = {["varname"] = "_btnApplyList",["events"] = {{["event"] = "touch",["method"] = "onApplyList",["sound_id"] = 0}}},
    ["Button_1_0_0"]              = {["varname"] = "_btnLegionCampaign",["events"] = {{["event"] = "touch",["method"] = "onLegionCampaign"}}},
    ["Button_help"]               = {["varname"] = "_btnCropHelp",["events"] = {{["event"] = "touch",["method"] = "onHelp",["sound_id"] = 0}}},
...
function CropMy:initBtn()
    self._btnOperator1:addClickEventListenerWithSound(function()
        ...
        network:sendPacket(Protocol.C_2_S_CROP_APPOINT, {role_id = data.id, pos = 0, city_id = 0})
    end)
    ...
    self._btnOperator5:addClickEventListener(function()
