...
CropTech.RESOURCE_BINDING = {
    ...
    ["button_silver"]                   = {["varname"] = "_btnSilver",["events"] = {{["event"] = "touch",["method"] = "onSilver",["sound_id"] = 63}}},
    ["button_gold"]                     = {["varname"] = "_btnGold",["events"] = {{["event"] = "touch",["method"] = "onGold",["sound_id"] = 63}}},
...
function CropTech:onCreate()
    ...
    self._nodeLeft:setPositionX(-(display.width / 2))
    ...
    self._nodeRight:setPositionX(display.width)
