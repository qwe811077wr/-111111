...
EmbattleGeneralTip.RESOURCE_BINDING = {
    ...
    ["Button_30"]               = {["varname"] = "_btnChange",["events"] = {{["event"] = "touch",["method"] = "onBtnRebuild",["sound_id"] = 75}}},
}
...
function EmbattleGeneralTip:setInfoData(info)
    ...
    self._panelGeneral:setContentSize(cc.size(self._baseSize.width, self._baseSize.height + delta))
