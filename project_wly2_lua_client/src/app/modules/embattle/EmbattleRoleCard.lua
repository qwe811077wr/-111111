...
EmbattleRoleCard.RESOURCE_BINDING = {
    ...
    ["Panel_3_0"]                       ={["varname"]="_panelClick",["events"]={{["event"]="touch",["method"]="onBgTouch",["sound_id"] = 0}}},
    ["Button_1"]                        ={["varname"]="_btnChange",["events"] = {{["event"] = "touch",["method"] = "onBtnRebuild",["sound_id"] = 77}}},
}
...
function EmbattleRoleCard:setData(index, role_type, data, is_drill, game_mode) --index 武将编号
    ...
    self:setRoleData(role_data, is_drill, self._gameMode)
end
...
function EmbattleRoleCard:setRoleData(role_data, is_drill, game_mode)
    ...
    item:setData(role_data, game_mode)
