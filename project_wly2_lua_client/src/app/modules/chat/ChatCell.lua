...
function ChatCell:ctor()
    ...
    self._imgBgLeft:addClickEventListenerWithSound(function(sender)
        self:onOpenPersonalInfo()
    end)
    self._imgBgRight:setTouchEnabled(true)
    self._imgBgRight:addClickEventListenerWithSound(function(sender)
        self:onOpenPersonalInfo()
    end)
end
...
function ChatCell:setShareInfo(panel, info)
    ...
    panel:getChildByName("Button_1"):addClickEventListenerWithSound(function()
