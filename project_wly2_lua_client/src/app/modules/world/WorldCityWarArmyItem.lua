...
function WorldCityWarArmyItem:onCreate()
    ...
    self._btnEmbattle:setPressedActionEnabled(true)
    self._btnPos:setPressedActionEnabled(true)
...
function WorldCityWarArmyItem:setBgTouchClick(call_back)
    ...
    self._bgImg:addClickEventListener(function(sender)
        local sound_id = not self._nodeBtn:isVisible() and uq.config.constant.COMMON_SOUND.BUTTON_TWO or uq.config.constant.COMMON_SOUND.BUTTON
