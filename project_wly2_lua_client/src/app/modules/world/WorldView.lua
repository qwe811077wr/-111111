...
WorldView.RESOURCE_BINDING = {
    ...
    ["node_left_middle/Node_left_view/Node_report/btn_report"]                      = {["varname"] = "_btnReport",["events"] = {{["event"] = "touch",["method"] = "onReport",["sound_id"] = 0}}},
...
function WorldView:onCreate()
    ...
    self._btnReport:setPressedActionEnabled(true)
    self._btnGuozheng:setPressedActionEnabled(true)
    self._btnCity:setPressedActionEnabled(true)
