...
EquipReplace.RESOURCE_BINDING  = {
    ...
    ["btn_advanced"]    ={["varname"] = "_btnReplace", ["events"] = {{["event"] = "touch",["method"] = "onReplace",["sound_id"] = 0}}},
    ["Button_1"]        ={["varname"] = "_onExit", ["events"] = {{["event"] = "touch",["method"] = "_onTouchExit",["sound_id"] = 0}}},
}
