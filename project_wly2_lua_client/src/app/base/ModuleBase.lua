...
function ModuleBase:playerSound()
    local sound_id = self._params.sound_id or uq.config.constant.COMMON_SOUND.SHOW
    uq.playSoundByID(sound_id)
end

function ModuleBase:setSwallowBgTouch(flag)
    self._baseBg:setSwallowTouches(flag)
end
