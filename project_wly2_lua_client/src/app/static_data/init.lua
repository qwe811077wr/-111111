...
StaticData['instance_war'] = {}
StaticData.initInstanceWarData = function(contry_id)
    for k, item in pairs(StaticData.load('ConflictCfgs').Conflict) do
        StaticData['instance_war'][k] = item
    end

    for _, v in pairs(StaticData['instance_war']) do
        local p = StaticData['instance_war'][v.parentId]
        if p then
            p.next = v
            v.parent = p
        end
...
StaticData['instance_city'] = StaticData.load('CampaignCity').city
StaticData['instance_power'] = StaticData.load('ConflictCfgs').power
StaticData['soldier'] = StaticData.load('Soldiers').Soldier
StaticData['world_soldier'] = StaticData.load('WorldSoldiers').Soldier
...
StaticData['bg_tx']            = StaticData.load('MapTx').bgTx
StaticData['general_appoint']  = StaticData.load('GeneralAppoint')
